...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvHabitTitle: TextView = itemView.findViewById(R.id.pager_tv_title)
        private val tvStartTime: TextView = itemView.findViewById(R.id.pager_tv_start_time)
        val ivPriorityLevel: ImageView = itemView.findViewById(R.id.item_priority_level)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            tvHabitTitle.text = pageData.title
